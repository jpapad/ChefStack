...
interface RecipeCardModernProps {
  recipe: Recipe;
  isSelected: boolean;
  onClick: () => void;
  isBookMode?: boolean;
...
export const RecipeCardModern: React.FC<RecipeCardModernProps> = React.memo(({
  recipe,
  isSelected,
  onClick,
  isBookMode = false,
...
RecipeCardModern.displayName = 'RecipeCardModern';

export default RecipeCardModern;
