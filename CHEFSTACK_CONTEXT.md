...
- GitHub repo: https://github.com/jpapad/ChefStack

> Σημείωση: Σε κάθε νέα συνομιλία στο ChatGPT, κάνω paste **όλο αυτό το αρχείο** (CHEFSTACK_CONTEXT.md) ως πρώτο μήνυμα, ώστε το μοντέλο να έχει:
> - το ιστορικό του project
> - το link του repo για να μπορεί να ανοίγει αρχεία από το GitHub
